...
from services.transaction_service import (
    ...
    update_transaction,
    delete_transaction,
    delete_history_transaction  # CRITICAL: Import the new history service function
)
...
# ---------------------------------------------------------
# 1. HISTORY MANAGEMENT (Moved to top to avoid 405 conflicts)
# ---------------------------------------------------------
...
async def delete_single_history_item(
    ...
    # Call the logic from transaction_service.py targeting the 'history' collection
    deleted = await delete_history_transaction(db, user_email, transaction_number)
